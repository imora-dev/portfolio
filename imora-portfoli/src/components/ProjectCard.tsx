...
export const ProjectCard = () => {
    return (
        <div className="flex justify-center items-center space-x-8 mx-auto mt-6"> {/* Flexbox container */}
            {/* Card */}
            <div className="card w-80 h-auto bg-gray-700/60 rounded-2xl overflow-hidden relative transition-all duration-300 hover:shadow-[0_0_30px_rgba(1,191,97,0.5)]">
                <div className="card-content p-4 relative z-10">
                    <div className="flex items-center mb-4">
                        <div>
                            <p className="font-futura text-2xl">fulbopago</p>
                    ...
                    <div className="mb-4">
                        ...
                        <ul className="text-xs text-white/60 grid grid-cols-1 gap-1">
                            {[
                                "Diseño de motor de calculo de turnos",
                                "Escalar horizontal",
                                "Implementar mercado pago",
                                "Crear toda la ui",
                                "Resolucion de problemas del nicho",
                            ].map((task) => (
                    ...
                    <div className="flex justify-between items-center space-x-2">
                        <a target="_blank" href="https://fulbopago.com.ar/Bienvenida" className="flex-1 bg-white/10 text-white/90 rounded-lg px-3 py-2 text-xs font-medium transition duration-300 ease-in-out hover:bg-white/20 flex items-center justify-center border border-white/20 rounded-xl">
