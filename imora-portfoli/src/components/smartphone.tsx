...
return(
    <div className="group cursor-pointer hover:skew-x-6 hover:-skew-y-6 hover:duration-500 duration-500 group-hover:duration-500 overflow-hidden relative  rounded-2xl shadow-inner  flex flex-col justify-around items-center w-64 h-90 bg-transparent text-transparent">
